...
//     {/* EDIT */}
//     <TouchableOpacity
//       style={[styles.swipeBtn, { backgroundColor: "#0a84ff" }]}
//       onPress={() => {
//         router.push({
//           pathname: "/add-menu",
//           params: {
...
//         <Swipeable
//       ref={(ref) => {
//         swipeableRefs.current[item.id] = ref; // ✅ just assign, don't return anything
//       }}
...
//   addMenuText: { color: "#0a84ff", fontWeight: "600", fontSize: 14 },
